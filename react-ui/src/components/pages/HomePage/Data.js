export const homeObjOne = {
    ...
    lightText: true,
    lightTextDesc: true,
    topLine: '¿Qué son los DeepFakes?',
    headline: 'Actualmente suponen un reto en la lucha contra la desinformación',
    description:
      ...
      'Se consideran una fuente de preocupación porque a menudo se las utiliza para inducir a error intencionalmente, como hacer que parezca que un político dijo algo que no dijo, o hacer que parezca que una celebridad estaba en un vídeo pornográfico en el que no estaba.',
  ...
  export const homeObjThree = {
    ...
    lightText: false,
    lightTextDesc: false,
    topLine: 'Reverse Engineering',
    headline: 'Herramienta para análisis de imágenes',
    description:
      'Utiliza este algoritmo para la detecciónd de DeepFakes en imágenes desarrollado por Facebook. Este algorimto utiliza ingeniería inversa para saber si una imagen ' +
      'ha sido manipulada, aprendiendo las "huellas" que dejan cada uno de los algoritmos',
